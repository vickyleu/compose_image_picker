 ...
 * [ColorfulSlider]
 */
internal data class SliderBrushColor(
...
internal val ThumbColor = Color(0xfff0f0f0)
internal val ActiveTrackColor = Color(0xff489cef)
internal val InactiveTrackColor = Color(0xffcccccc)

internal object MaterialSliderDefaults {

    fun Color.toBrush():SliderBrushColor{
        return SliderBrushColor(this)
    }
    @Composable
    private fun primarySolidColor() = androidx.compose.material3.MaterialTheme.colorScheme.primary
    ...
    @Composable
    private fun disabledThumbSolidColor() = androidx.compose.material3.MaterialTheme.colorScheme.onSurface
        .copy(alpha = 0.6f)
    ...
    private fun disabledActiveTrackSolidColor() =
        androidx.compose.material3.MaterialTheme.colorScheme.onSurface.copy(alpha = DisabledActiveTrackAlpha)
 ...
 */
@Stable
internal interface MaterialSliderColors {
